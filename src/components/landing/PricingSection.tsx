...
const tiers = [
  {
    ...
    price: "$0",
    period: "forever",
    features: ["30-day challenge tracker", "Daily journal prompts", "Pattern identification", "Community access"],
    cta: "Start Free",
    highlight: false,
  },
  {
    ...
    price: "$27",
    period: "/mo",
    features: ["Everything in Free", "Spreadsheet Pack (9 tabs)", "17 Custom GPTs", "Pattern Quiz", "Priority support"],
    cta: "Go Premium",
    highlight: true,
  },
  {
    ...
    price: "$97",
    period: "/mo",
    features: ["Everything in Premium", "1-on-1 coaching calls", "Alignment Lab access", "Custom pattern analysis", "Private community"],
    cta: "Join VIP",
    highlight: false,
  },
];
